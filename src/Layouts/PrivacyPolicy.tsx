  ...
  return (
    <div>
      ...
      <div style={{marginTop:"5%"}}>
        <h1>Privacy Policy for Rent4Event</h1>

        <p>
          At info.rent4event@gmail.com, accessible from NA, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by info.rent4event@gmail.com and how we use it.
        </p>
        ...
        <p>
          info.rent4event@gmail.com follows a standard procedure of using log
        ...
        <p>
          Like any other website, info.rent4event@gmail.com uses 'cookies'.
        ...
        <p>
          ...
          advertising partners of info.rent4event@gmail.com.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on info.rent4event@gmail.com,
        ...
        <p>
          Note that info.rent4event@gmail.com has no access to or control over
        ...
        <p>
          info.rent4event@gmail.com's Privacy Policy does not apply to other
        ...
        <p>
          info.rent4event@gmail.com does not knowingly collect any Personal
        ...
        <p>
          ...
          shared and/or collect in info.rent4event@gmail.com. This policy is not
